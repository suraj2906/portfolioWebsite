  ...
  return (
    <div className='absolute top-0 md:px-[10%] w-[100%] md:py-[3%] px-[5%] py-[10%] font-cruell md:text-3xl text-[12px]'>
        ...
        className='flex flex-row justify-between text-white'>
            ...
            <motion.li className='font-vintage md:text-6xl text-[15px] border solid rounded-full w-12 h-12 md:w-auto md:h-auto flex items-center justify-center md:p-5 p-3 md:-mt-5 -mt-2'><a href='https://github.com/suraj2906' target='_blank'>SS</a></motion.li>
